...
CalendarWidget.initialize = function (o, onChoosed, onHidden) {
    var self = this;
    ...
    function onputdate(e) {
        ...
        if (data === 'day') {
            ...
            onChoosed(date.year + '-' + date.month + '-' + date.date);
            _hide(content);
            onHidden();
        }
    ...
    eui.addHandler(input, 'click', function () {
...
eui.calendar = function (o, onChoosed, onHidden) {
    var calendarWidget = CalendarWidget;
    calendarWidget.initialize(o, onChoosed, onHidden);
};
